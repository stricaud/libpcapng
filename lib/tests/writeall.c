...
int main(int argc, char **argv)
{
	...
	size_t buffer_size;
 	...
 	unsigned char *pkt = (unsigned char *)"\x45\x00\x00\x28\x00\x01\x00\x00\x40\x06\x0c\xea\xac\x10\x00\x2a\xc0\xa8\x01\x03\x46\x11\x00\x50\x00\x00\x00\x00\x00\x00\x00\x00\x50\x02\x20\x00\xdb\x9b\x00\x00";
	size_t pkt_len = 40;

	unsigned char *custom = (unsigned char *)"helo";
